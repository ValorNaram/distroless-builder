...
See link:../collector_resources/tools/pause.sh[collector_resources/tools/pause.sh] for a working example.
...
See link:../collector_resources/tools/start-collecting[collector_resources/tools/start-collecting] for how this is implemented by default.
...
Use a `Containerfile` and your favourite container orchestrator to build the image to be used as worker container. See link:../collector_resources/Containerfile[collector_resources/Containerfile] how the default image is build.
